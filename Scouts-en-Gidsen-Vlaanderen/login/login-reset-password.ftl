    ...
    <#if section = "content">
      ...
      <form id="kc-form-login" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
        <div>
          ...
          <input id="username" class="input-field" name="username" type="text" autofocus placeholder="Gebruikersnaam of lidnummer" value="${(formData.username[0])!''}" tabindex="1" />
        ...
        <div>
          ...
          <input id="email" class="input-field" name="email" type="text" autofocus placeholder="E-mail of gsm-nummer" value="${(formData.email[0])!''}" tabindex="2"/>
        </div>
